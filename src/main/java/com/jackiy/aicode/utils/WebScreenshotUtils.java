...
public class WebScreenshotUtils {
    ...
    private static WebDriver initChromeDriver(int width, int height) {
        try {
            String localDriverPath = "src/main/resources/drivers/chromedriver.exe";
            // String localDriverPath = "src/test/resources/drivers/chromedriver"; // Linux/macOS 示例
            System.setProperty("webdriver.chrome.driver", localDriverPath);

            // 自动管理 ChromeDriver 现在我手动，先注释掉
