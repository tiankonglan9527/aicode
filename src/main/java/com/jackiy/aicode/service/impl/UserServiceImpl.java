package com.jackiy.aicode.service.impl;
...
import static com.jackiy.aicode.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>  implements UserService {
    ...
    // 分页查询用户信息
    @Override
    public QueryWrapper QueryWrapper(UserQueryRequest userQueryRequest) {
